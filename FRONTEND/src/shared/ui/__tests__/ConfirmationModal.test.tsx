...
describe('ConfirmationModal', () => {
  ...
  test('deve renderizar o modal com título e mensagem corretos', () => {
    ...
    expect(screen.getByText('Tem certeza que deseja prosseguir?')).toBeInTheDocument(); // Still checking for the message text
  });
  ...
  test('deve renderizar com textos de botão personalizados', () => {
    render(<ConfirmationModal {...defaultProps} confirmText="Sim" cancelText="Não" />);
