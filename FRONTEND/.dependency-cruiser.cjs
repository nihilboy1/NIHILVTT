  ...
  forbidden: [
    {
      ...
      comment: "A camada 'shared' é a base e não pode depender de nenhuma outra camada superior.",
      severity: 'error',
      from: {
        path: '^src/shared',
      ...
      to: {
        path: ['^src/entities', '^src/features', '^src/widgets', '^src/pages', '^src/app'],
      },
    },
    {
    ...
    },
    {
      name: 'no-circular',
      severity: 'error',
      comment: 'Dependências circulares são proibidas pois tornam o código frágil e imprevisível.',
      from: {},
      to: {
        circular: true,
      },
    },
    {
      ...
      from: {
        ...
        pathNot: [
          ...
          'src/features/characterBuilder/types/effectTypes\\.ts$',
        ],
      },
      to: {},
    },
