// src/domain/spell/spells.data.ts
var spellsPart1 = [
  {
    ...
    description: "Voc\xEA cria uma bolha \xE1cida em um ponto dentro do alcance, onde ela explode em um raio de 1,5 metro (5 foot). Cada criatura nessa \xE1rea deve ser bem-sucedida em um teste de resist\xEAncia de Destreza ou sofrer 1d6 de dano \xE1cido.",
    effects: [
      {
          ...
          rules: [
            {
              ...
              newFormula: { dice: "2d6", damageType: "acid" }
            },
            {
              level: 11,
              outcomeId: "acid-splash-damage",
              newFormula: { dice: "3d6", damageType: "acid" }
            },
            {
              level: 17,
              outcomeId: "acid-splash-damage",
              newFormula: { dice: "4d6", damageType: "acid" }
            }
          ]
        }
      }
  ...
  },
  {
    id: "spell-alarme",
    name: "Alarme",
    description: "Voc\xEA prepara um alarme contra invas\xF5es. Escolha uma porta, uma janela ou uma \xE1rea dentro do alcance que n\xE3o seja maior que um cubo de 6 metros (20 p\xE9s). At\xE9 o fim da magia, um alarme alerta voc\xEA sempre que uma criatura designada tocar ou entrar na \xE1rea protegida. Ao conjurar a magia, voc\xEA pode designar criaturas que n\xE3o ativar\xE3o o alarme. Voc\xEA tamb\xE9m escolhe se o alarme ser\xE1 aud\xEDvel ou mental.",
    source: "LDJ2024",
    page: 239,
    level: 1,
    school: "abjuration",
    ...
    components: {
      ...
      material: "Um sininho e um fio de prata que s\xE3o consumidos pela magia."
    },
    duration: {
      unit: "hour",
      value: 8
    ...
    effects: [
      {
        ...
        parameters: {
          activation: {
            type: "special",
            trigger: "1 minuto de conjura\xE7\xE3o"
          },
          range: { normal: 30, unit: "ft" },
          target: {
            type: "descriptive",
            text: "Uma porta, janela ou ponto no espa\xE7o que se torna o centro da \xE1rea protegida."
          },
  ...
  },
  {
    ...
    entries: [
      ...
      "When you cast the spell, you change the current weather conditions, which are determined by the DM. You can change precipitation, temperature, and wind. It takes {@dice 1d4 \xD7 10} minutes for the new conditions to take effect. Once they do so, you can change the conditions again. When the spell ends, the weather gradually returns to normal.",
  ...
  },
  {
    ...
    entries: [
      ...
      "You can also cause the effects below.",
      {
        ...
        name: "Fissures",
        entries: [
          "A total of {@dice 1d6} fissures open in the spell's area at the end of the turn you cast it. You choose the fissures' locations, which can't be under structures. Each fissure is {@dice 1d10 \xD7 10} feet deep and 10 feet wide, and it extends from one edge of the spell's area to another edge. A creature in the same space as a fissure must succeed on a Dexterity saving throw or fall in. A creature that successfully saves moves with the fissure's edge as it opens."
        ]
      },
      {
        type: "entries",
