import { Item } from "../../domain/item/items.schema.js";
          ...
          outcomes: [
            {
              on: "hit",
              type: "damage",
              formula: { roll: { count: 2, faces: 6 }, damageType: "acid" },
            },
          ],
        },
      },
          ...
          outcomes: [
            {
              ...
              formula: { roll: { count: 1, faces: 4 }, damageType: "fire" },
            },
          ],
        },
      },
          ...
          outcomes: [
            {
              ...
              formula: { roll: { count: 1, faces: 4 }, damageType: "poison" },
            },
          ],
        },
      },
          ...
          outcomes: [
            {
              ...
              type: "damage",
              formula: {
                roll: { count: 1, faces: 1, modifier: -1 },
                damageType: "piercing",
              },
            },
          ...
          outcomes: [
            {
              ...
              formula: { roll: { count: 2, faces: 6 }, damageType: "radiant" },
            },
          ],
        },
      },
          ...
          outcomes: [
            {
              on: "fail",
              type: "damage",
              formula: { roll: { count: 1, faces: 4 }, damageType: "piercing" },
            },
  ...
  },
  {
    ...
    effects: [
      ...
      },
      {
        ...
        mastery: [],
        damage: {
          primary: { fixed: 1, damageType: "fire" }, // Dano 1
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        mastery: ["topple"],
        damage: {
          primary: { roll: { count: 1, faces: 8 }, damageType: "slashing" },
          versatile: { roll: { count: 1, faces: 10 }, damageType: "slashing" },
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        mastery: ["slow"],
        damage: {
          primary: { roll: { count: 1, faces: 4 }, damageType: "bludgeoning" },
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        mastery: ["nick"],
        damage: {
          primary: { roll: { count: 1, faces: 4 }, damageType: "piercing" },
        },
    ...
    effects: [
      {
        ...
        mastery: ["sap"],
        damage: {
          primary: { roll: { count: 1, faces: 8 }, damageType: "bludgeoning" },
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        mastery: ["graze"],
        damage: {
          primary: { roll: { count: 1, faces: 10 }, damageType: "slashing" },
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        mastery: ["cleave"],
        damage: {
          primary: { roll: { count: 1, faces: 12 }, damageType: "slashing" },
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        mastery: ["graze"],
        damage: {
          primary: { roll: { count: 2, faces: 6 }, damageType: "slashing" },
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        damage: {
          primary: { roll: { count: 1, faces: 6 }, damageType: "piercing" },
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        range: { normal: 20, long: 60, unit: "ft" },
        damage: {
          primary: { roll: { count: 1, faces: 6 }, damageType: "slashing" },
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        damage: {
          primary: { roll: { count: 1, faces: 10 }, damageType: "piercing" },
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        damage: {
          primary: { roll: { count: 1, faces: 8 }, damageType: "piercing" },
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        mastery: ["sap"],
        damage: {
          primary: { roll: { count: 1, faces: 6 }, damageType: "bludgeoning" },
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        mastery: ["topple"],
        damage: {
          primary: { roll: { count: 2, faces: 6 }, damageType: "bludgeoning" },
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        damage: {
          primary: { roll: { count: 1, faces: 12 }, damageType: "piercing" },
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        mastery: ["nick"],
        damage: {
          primary: { roll: { count: 1, faces: 4 }, damageType: "slashing" },
        },
      },
    ],
  },
    ...
    effects: [
      {
        ...
        damage: {
          primary: { roll: { count: 1, faces: 6 }, damageType: "piercing" },
          versatile: { roll: { count: 1, faces: 8 }, damageType: "piercing" },
        },
      },
    ],
  },
