const subrace = [
  ...
  },
  {
    ...
    traitTags: ["Dragonmark", "Skill Bonus Dice", "Tool Bonus Dice"],
    additionalSpells: [
      {
        expanded: {
          s1: ["alarm", "armor of agathys"],
          s2: ["arcane lock", "knock"],
          s3: ["glyph of warding", "magic circle"],
          s4: ["leomund's secret chest", "mordenkainen's faithful hound"],
          s5: ["antilife shell"],
        },
        ability: "int",
        known: {
  ...
  },
  {
    ...
    traitTags: ["Dragonmark", "Skill Bonus Dice"],
    additionalSpells: [
      {
        innate: {
          "3": {
        ...
        expanded: {
          s1: ["disguise self", "silent image"],
          s2: ["darkness", "pass without trace"],
          s3: ["clairvoyance", "major image"],
          s4: ["greater invisibility", "hallucinatory terrain"],
          s5: ["mislead"],
        },
        ability: "cha",
        known: {
      ...
      },
      {
        ...
        entries: [
          "If you have the Spellcasting or the Pact Magic class feature, the spells on the Mark of Shadow Spells table are added to the spell list of your spellcasting class.",
          {
            ...
            colStyles: ["col-2 text-center", "col-10"],
            rows: [
              ["1st", "{@spell disguise self}, {@spell silent image}"],
              ["2nd", "{@spell darkness}, {@spell pass without trace}"],
              ["3rd", "{@spell clairvoyance}, {@spell major image}"],
              [
                "4th",
  ...
  },
  {
    ...
    entries: [
      ...
      {
        name: "Extra Language",
        entries: ["You can speak, read, and write Aquan."],
        type: "entries",
      },
    ],
    hasFluff: true,
  ...
  },
  {
    ...
    entries: [
      {
        name: "Fleet of Foot",
        entries: ["Your ground speed increases to 35 feet."],
        type: "entries",
        data: {
  ...
  },
  {
    ...
    entries: [
      ...
      {
        name: "Superior Darkvision",
        entries: ["Your Darkvision has a radius of 120 feet."],
        data: {
          overwrite: "Darkvision",
        },
        type: "entries",
  ...
  },
  {
    ...
    traitTags: ["Skill Proficiency", "Tool Proficiency"],
    ...
    entries: [
      {
        ...
        entries: ["You have resistance to acid damage."],
        type: "entries",
      },
      {
        name: "Amphibious",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        type: "entries",
        name: "Amphibious",
        entries: ["You breathe air and water."],
      },
      {
        type: "entries",
        name: "Call to the Wave",
    ...
    additionalSpells: [
      {
        ...
        expanded: {
          s1: ["comprehend languages", "illusory script"],
          s2: ["animal messenger", "silence"],
          s3: ["sending", "tongues"],
          s4: ["arcane eye", "confusion"],
          s5: ["dream"],
        },
        ability: "int",
        known: {
  ...
  },
  {
    ...
    entries: [
      ...
      {
        name: "Tuktuk Cunning",
        entries: ["You have proficiency with {@item thieves' tools|phb}."],
        type: "entries",
      },
    ],
    hasFluff: true,
    ...
    additionalSpells: [
      {
        ...
        expanded: {
          s1: ["detect evil and good", "detect poison and disease"],
          s2: ["detect thoughts", "find traps"],
          s3: ["clairvoyance", "nondetection"],
          s4: ["arcane eye", "divination"],
          s5: ["legend lore"],
        },
        ability: "int",
      },
    ...
    additionalSpells: [
      {
        expanded: {
          ...
          s2: ["gust of wind", "levitate"],
          s3: ["sleet storm", "wind wall"],
          s4: ["conjure minor elementals", "control water"],
          s5: ["conjure elemental"],
        },
        ability: "cha",
        known: {
          "1": ["gust|xge#c"],
    ...
    additionalSpells: [
      {
        ...
        expanded: {
          s1: ["faerie fire", "longstrider"],
          s2: ["locate animals or plants", "locate object"],
          s3: ["clairvoyance", "speak with plants"],
          s4: ["divination", "locate creature"],
          s5: ["commune with nature"],
        },
        ability: "wis",
      },
    ],
    ...
    additionalSpells: [
      {
        ...
        expanded: {
          s1: ["cure wounds", "healing word"],
          s2: ["lesser restoration", "prayer of healing"],
          s3: ["aura of vitality", "mass healing word"],
          s4: ["aura of purity", "aura of life"],
          s5: ["greater restoration"],
        },
        ability: "wis",
      },
    ],
      ...
      },
      {
        ...
        entries: [
          "If you have the Spellcasting or the Pact Magic class feature, the spells on the Mark of Healing Spells table are added to the spell list of your spellcasting class.",
          {
            ...
            colStyles: ["col-2 text-center", "col-10"],
            rows: [
              ["1st", "{@spell cure wounds}, {@spell healing word}"],
              [
                "2nd",
                "{@spell lesser restoration}, {@spell prayer of healing}",
              ],
              ["3rd", "{@spell aura of vitality}, {@spell mass healing word}"],
              ["4th", "{@spell aura of purity}, {@spell aura of life}"],
              ["5th", "{@spell greater restoration}"],
            ],
          },
        ],
      },
    ...
    additionalSpells: [
      {
        expanded: {
          s1: ["goodberry", "sleep"],
          s2: ["aid", "calm emotions"],
          s3: ["create food and water", "leomund's tiny hut"],
          s4: ["aura of purity", "mordenkainen's private sanctum"],
          s5: ["hallow"],
        },
        ability: "cha",
        known: {
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        entries: ["You have proficiency in Strength saving throws."],
      },
      {
        type: "entries",
        name: "Icehaven Born",
  ...
  },
  {
    ...
    additionalSpells: [
      {
        expanded: {
          s1: ["animal friendship", "speak with animals"],
          s2: ["beast sense", "calm emotions"],
          s3: ["beacon of hope", "conjure animals"],
          s4: ["aura of life", "dominate beast"],
          s5: ["awaken"],
        },
        ability: "wis",
        known: {
      ...
      },
      {
        ...
        entries: [
          "If you have the Spellcasting or the Pact Magic class feature, the spells on the Mark of Making Spells table are added to the spell list of your spellcasting class.",
          {
            ...
            colStyles: ["col-2 text-center", "col-10"],
            rows: [
              ["1st", "{@spell identify}, {@spell Tenser's floating disk}"],
              ["2nd", "{@spell continual flame}, {@spell magic weapon}"],
              ["3rd", "{@spell conjure barrage}, {@spell elemental weapon}"],
              ["4th", "{@spell fabricate}, {@spell stone shape}"],
              ["5th", "{@spell creation}"],
            ],
          },
        ],
    ...
    ability: [
      {
        dex: 2,
        choose: {
          from: ["str", "con", "int", "wis", "cha"],
          count: 1,
        },
      },
    ],
    traitTags: ["Dragonmark"],
    additionalSpells: [
      {
        expanded: {
          s1: ["expeditious retreat", "jump"],
          s2: ["misty step", "pass without trace"],
          s3: ["blink", "phantom steed"],
          s4: ["dimension door", "freedom of movement"],
          s5: ["teleportation circle"],
        },
        ability: "dex",
        known: {
          "1": ["misty step"],
  ...
  },
  {
    ...
    additionalSpells: [
      {
        expanded: {
          s1: ["compelled duel", "shield of faith"],
          s2: ["warding bond", "zone of truth"],
          s3: ["counterspell", "protection from energy"],
          s4: ["death ward", "guardian of faith"],
          s5: ["bigby's hand"],
        },
        ability: "wis",
        known: {
      ...
      },
      {
        ...
        entries: [
          "If you have the Spellcasting or the Pact Magic class feature, the spells on the Mark of Sentinel Spells table are added to the spell list of your spellcasting class.",
          {
            ...
            colStyles: ["col-2 text-center", "col-10"],
            rows: [
              ["1st", "{@spell compelled duel}, {@spell shield of faith}"],
              ["2nd", "{@spell warding bond}, {@spell zone of truth}"],
              ["3rd", "{@spell counterspell}, {@spell protection from energy}"],
              ["4th", "{@spell death ward}, {@spell guardian of faith}"],
              ["5th", "{@spell Bigby's hand}"],
            ],
          },
        ],
      },
  ...
  },
  {
    ...
    entries: [
      ...
      {
        name: "Fleet of Foot",
        entries: ["Your base walking speed is 40 feet."],
        type: "entries",
      },
      {
        name: "Sure-footed",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        name: "Shifting Feature",
        entries: [
          "While shifted, you can use your elongated fangs to make an unarmed strike as a bonus action. If you hit with your fangs, you can deal piercing damage equal to {@damage 1d6} + your Strength modifier, instead of the bludgeoning damage normal for an unarmed strike.",
        ],
      },
    ],
    hasFluff: true,
    ...
    entries: [
      {
        type: "entries",
        name: "Graceful",
        entries: ["You have proficiency in the {@skill Acrobatics} skill."],
      },
      {
        type: "entries",
        name: "Shifting Feature",
