...
export const RootParameterPaths = z.enum([
  ...
  'save.dc.value',
  'save.ignoreCovers',
  'save.rollModifier.ifFalse.mode',
  'save.rollModifier.ifFalse.type',
  'save.rollModifier.ifTrue.mode',
  'save.rollModifier.ifTrue.type',
  'save.rollModifier.triggers',
  'save.rollModifier.type',
  'target.details',
  'target.properties',
  'target.quantity',
  'target.type'
