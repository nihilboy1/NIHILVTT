...
import { CharacterType, type Character } from "../../shared/api/types"; // Ajustar o caminho do tipo
import { CharacterTemplateListItem } from "../token/CharacterTemplateListItem"; // Ajustar o caminho do componente

import { useCharacters } from "../../contexts/CharactersContext"; // Ajustar o caminho do contexto
