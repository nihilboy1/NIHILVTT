...
import { Tool, SidebarTab, RulerPlacementMode } from '../../types';
...
const renderToolbar = (
  ...
  (useUIState as jest.Mock).mockReturnValue({ ...defaultMockUIState, ...uiState });
  (useBoardSettingsState as jest.Mock).mockReturnValue({ ...defaultMockBoardSettingsState, ...boardSettingsState });
  (useChatState as jest.Mock).mockReturnValue({ ...defaultMockChatState, ...chatState });

  return render(
    <UIContext.Provider value={{ ...defaultMockUIState, ...uiState }}>
      <BoardSettingsContext.Provider value={{ ...defaultMockBoardSettingsState, ...boardSettingsState }}>
