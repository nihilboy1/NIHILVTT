...
import {
  useBoardSettingsState,
  type BoardSettingsState,
} from "../hooks/useBoardSettingsState"; // Import the custom hook

export const BoardSettingsContext = createContext<
  BoardSettingsState | undefined
>(undefined);

export const BoardSettingsProvider: React.FC<{ children: ReactNode }> = ({
  children,
}) => {
