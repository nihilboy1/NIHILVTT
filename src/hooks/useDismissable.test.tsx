...
const TestComponent: FC<TestComponentProps> = ({ isOpen, onClose, ignoredClass }) => {
...
describe('useDismissable', () => {
  ...
  it('deve ignorar cliques em elementos com a classe ignorada', async () => {
    render(<TestComponent isOpen={true} onClose={mockOnClose} ignoredClass="ignored-class" />);
  ...
  it('deve remover listeners quando o componente é desmontado', () => {
    const { unmount } = render(<TestComponent isOpen={true} onClose={mockOnClose} />);
