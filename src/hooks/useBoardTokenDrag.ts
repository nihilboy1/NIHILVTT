...
import { Tool, type PageSettings, type Point } from "../shared/api/types";
import { parseTokenSize } from "../shared/lib/utils/board/boardUtils"; // Renomeado

const CLICK_THRESHOLD_MS = 200;

interface UseBoardTokenDragProps { // Renomeado
...
export const useBoardTokenDrag = ({
  tokenId,
  initialPosition,
  characterSize,
  cellSize,
